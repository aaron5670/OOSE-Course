...
class OrdersWriterTest {
    ...
    void emptyOrdersReturnsCorrectJsonString() {
        ...
        // Act
        var ordersContent = ordersWriter.writeOrders();
    ...
    void oneOrderWithOneProductReturnsCorrectJsonString() {
        // Arrange
        order111.AddProduct(new Product("Shirt", "blue", 3, 2.99, "TWD"));
    ...
    void oneOrderWithOneProductNoSizeReturnsCorrectJsonString() {
        // Arrange
        order111.AddProduct(new Product("Pot", "red", -1, 16.50, "SGD"));
    ...
    {
        // Arrange
        order111.AddProduct(new Product("Shirt", "blue", 1, 2.99, "TWD"));
    ...
    {
        // Arrange
        order111.AddProduct(new Product("Shirt", "red", 2, 2.99, "TWD"));
    ...
    {
        // Arrange
        order111.AddProduct(new Product("Shirt", "yellow", 3, 2.99, "TWD"));
    ...
    {
        // Arrange
        order111.AddProduct(new Product("Shirt", "green", 4, 2.99, "TWD"));
        order111.AddProduct(new Product("Shirt", "green", 5, 2.99, "TWD"));
        order111.AddProduct(new Product("Shirt", "green", 6, 2.99, "TWD"));
        order111.AddProduct(new Product("Shirt", "green", 7, 2.99, "TWD"));
